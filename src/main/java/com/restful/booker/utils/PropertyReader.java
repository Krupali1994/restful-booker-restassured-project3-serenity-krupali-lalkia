...
public class PropertyReader {
    ...
    public String getProperty(String propertyName){
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir")+"/C:\\Users\\ahirg\\IdeaProjects\\restful-booker-restassured-project3-serenity-krupali-lalkia\\src\\test\\resources\\propertyfile\\application.properties");
